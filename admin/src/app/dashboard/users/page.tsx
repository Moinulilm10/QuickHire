...
type UsersAction = { type: "SET_PAGE"; payload: number };

const initialUsersState: UsersState = { currentPage: 1 };
...
function UsersDataContent({
  ...
  dataPromise: Promise<UsersResponse>;
  isPending: boolean;
  state: UsersState;
  ...
  return (
    <>
      ...
      <div
        className="bg-surface rounded-2xl border border-surface-border shadow-sm overflow-hidden transition-opacity duration-200"
    ...
    <>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-surface p-6 rounded-2xl border border-surface-border shadow-sm">
        <div>
          ...
          <p className="text-text-muted mt-1">Loading users...</p>
        </div>
      </div>
      <div className="flex items-center justify-center p-12 bg-surface rounded-2xl border border-surface-border">
